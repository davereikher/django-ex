...
function confirmSplitGroup(){
	var checkbox = document.getElementById("checkINDISPLIT");
	if (checkbox.checked == true){
	   alert("This is not a standard operation! Please be sure that you want this and that you know what you are doing! If you are not sure, please ask before carrying out this operation.");
	}
	return;
}